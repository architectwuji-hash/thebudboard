...
export const CONFIG = {
  ...
  RENDER3D: {
    ...
    baseEmissiveIntensity: 2.8,
    playerColor: 0x86efac,
    playerEmissive: 0x4ade80,
    playerEmissiveIntensity: 3.2,
    enemyColor: 0xffa1a1,
    enemyEmissive: 0xff6b6b,
    enemyEmissiveIntensity: 3.0,
    bulletColor: 0xfff176,
    bulletEmissive: 0xffeb3b,
    bulletEmissiveIntensity: 3.4,
    pickupColor: 0xfff59d,
    pickupEmissive: 0xffd54f,
    pickupEmissiveIntensity: 3.2,
    wallColor: 0xc4cad4,
    wallRoughness: 0.55,
    wallMetalness: 0.12,
    floorColor: 0x6b7fa8,
    floorEmissive: 0x4a5d82,
    floorEmissiveIntensity: 0.45,
    gutterColor: 0x556688,
    protectedColor: 0x627a9e,
