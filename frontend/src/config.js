...
export const CONFIG = {
  ...
  RENDER3D: {
    ...
    baseEmissiveIntensity: 1.15,
    playerColor: 0x22c55e,
    playerEmissive: 0x16a34a,
    playerEmissiveIntensity: 1.45,
    enemyColor: 0xef4444,
    enemyEmissive: 0xb91c1c,
    enemyEmissiveIntensity: 1.25,
    bulletColor: 0xfbbf24,
    bulletEmissive: 0xf59e0b,
    bulletEmissiveIntensity: 1.5,
    pickupColor: 0xfacc15,
    pickupEmissive: 0xeab308,
    pickupEmissiveIntensity: 1.35,
    wallColor: 0x7a7a8a,
    wallRoughness: 0.82,
    wallMetalness: 0.08,
    floorColor: 0x0f172a,
    gutterColor: 0x0a0e14,
    protectedColor: 0x0d1117,
